defmodule WhatsappApi do
  ...
  @spec send_message_media_general(MessageOutboundMediaGeneral.t(), String.t()) :: map()
  def send_message_media_general(%MessageOutboundMediaGeneral{} = message, provider) do
    provider
    |> AuthServer.get_token_info()
    |> Messages.send_media(message)
  end

  @spec send_hsm_interactive(MessageOutboundHsmInteractive.t(), String.t()) :: map()
  def send_hsm_interactive(%MessageOutboundHsmInteractive{} = message, provider) do
    provider
    |> AuthServer.get_token_info()
    |> Messages.send_hsm_interactive(message)
  end

  @spec send_hsm_otp(MessageOutboundHsmOtp.t(), String.t()) :: map()
  def send_hsm_otp(%MessageOutboundHsmOtp{} = message, provider) do
    provider
    |> AuthServer.get_token_info()
    |> Messages.send_hsm_otp(message)
  end
